...
const jsonFileName = path.join(rootPath, 'SCW', 'emvTransactionList.json');

const EMVTransactionManager = class {
    constructor() {
        this.load()
    }    
    ...
    getEMVTrans(networkId, plazaId, staffId, startDateTime, endDateTime) {
        let rets = []
        this.load()
        if (this.data && this.data.list) {
...
module.exports.EMVTransactionManager = exports.EMVTransactionManager = EMVTransactionManager;