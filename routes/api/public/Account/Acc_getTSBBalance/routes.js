...
//#region Implement - Acc_getTSBBalance

api.Acc_getTSBBalance = class {
    static prepare(req, res) {
        let params = WebServer.parseReq(req).data
        return params
    }
    static async call(db, params) { 
        return db.Acc_getTSBBalance(params)
    }
...
router.all('/', api.Acc_getTSBBalance.entry)

const init_routes = (svr) => {
    svr.route('/api/account/tsbcredit', router);
};
