...
//#region Implement - Acc_getReqDetail

api.Acc_getReqDetail = class {
    static prepare(req, res) {
        let params = WebServer.parseReq(req).data
        return params
    }
    static async call(db, params) { 
        return db.Acc_getReqDetail(params)
    }
...
router.all('/', api.Acc_getReqDetail.entry)

const init_routes = (svr) => {
    svr.route('/api/account/request/getdetail', router);
};
