...
//#region Implement - UpdateAR_Serial

api.UpdateAR_Serial = class {
    static prepare(req, res) {
        let params = WebServer.parseReq(req).data
        return params
    }
    static async call(db, params) { 
        return db.UpdateAR_Serial(params)
    }
...
router.all('/', api.UpdateAR_Serial.entry)

const init_routes = (svr) => {
    svr.route('/api/account/sap/save/arserial', router);
};
