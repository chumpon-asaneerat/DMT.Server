...
//#region Implement - TA_getTSBlist

api.TA_getTSBlist = class {
    static prepare(req, res) {
        let params = WebServer.parseReq(req).data
        return params
    }
    static async call(db, params) { 
        return db.TA_getTSBlist(params)
    }
...
router.all('/', api.TA_getTSBlist.entry)

const init_routes = (svr) => {
    svr.route('/api/account/sap/tsblist', router);
};
