...
//#region Implement - ta_getSAPCustomer

api.TA_getSAPCustomer = class {
    ...
    static async call(db, params) { 
        return db.TA_getSAPCustomer(params)
    }
...
router.all('/', api.TA_getSAPCustomer.entry)

const init_routes = (svr) => {
    svr.route('/api/account/sap/getcustomer', router);
};
