...
//#region Implement - GetTASellByRunNo

api.GetTASellByRunNo = class {
    static prepare(req, res) {
        let params = WebServer.parseReq(req).data
        return params
    }
    static async call(db, params) { 
        return db.GetTASellByRunNo(params)
    }
...
router.all('/', api.GetTASellByRunNo.entry)

const init_routes = (svr) => {
    svr.route('/api/account/sap/get/arcouponlist', router);
};
