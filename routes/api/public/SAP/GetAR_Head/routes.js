...
//#region Implement - GetAR_Head

api.GetAR_Head = class {
    static prepare(req, res) {
        let params = WebServer.parseReq(req).data
        return params
    }
    static async call(db, params) { 
        return db.GetAR_Head(params)
    }
...
router.all('/', api.GetAR_Head.entry)

const init_routes = (svr) => {
    svr.route('/api/account/sap/get/arhead', router);
};
