...
//#region Implement - UpdateAR_Head

api.UpdateAR_Head = class {
    static prepare(req, res) {
        let params = WebServer.parseReq(req).data
        return params
    }
    static async call(db, params) { 
        return db.UpdateAR_Head(params)
    }
...
router.all('/', api.UpdateAR_Head.entry)

const init_routes = (svr) => {
    svr.route('/api/account/sap/save/arhead', router);
};
