...
//#region Implement - TCTCheckTODBoj

api.TCTCheckTODBoj = class {
    static prepare(req, res) {
        let params = WebServer.parseReq(req).data
        return params
    }
    static async call(db, params) { 
        return db.TCTCheckTODBoj(params)
    }
...
router.all('/', api.TCTCheckTODBoj.entry)

const init_routes = (svr) => {
    svr.route('/api/TCT/CheckTODBoj', router);
};
