...
//#region Implement - TOD_SaveUserShift

api.TOD_SaveUserShift = class {
    static prepare(req, res) {
        let params = WebServer.parseReq(req).data
        return params
    }
    static async call(db, params) { 
        return db.TOD_SaveUserShift(params)
    }
...
router.all('/', api.TOD_SaveUserShift.entry)

const init_routes = (svr) => {
    svr.route('/api/TOD/UserShift/save', router);
};
