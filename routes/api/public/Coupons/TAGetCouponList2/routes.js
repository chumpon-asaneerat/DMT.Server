...
api.TAGetCouponList2 = class {
    ...
    static async call(db, params) { 
        return db.TAGetCouponList2(params)
    }
...
router.all('/', api.TAGetCouponList2.entry)

const init_routes = (svr) => {
    svr.route('/api/users/coupons/getlist2', router);
