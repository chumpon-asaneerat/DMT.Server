...
api.TCTSoldCoupon = class {
    ...
    static async call(db, params) { 
        return db.TCTSoldCoupon(params)
    }
...
router.all('/', api.TCTSoldCoupon.entry)

const init_routes = (svr) => {
    svr.route('/api/TCT/coupons/sold', router);
};
