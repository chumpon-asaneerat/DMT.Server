...
//#region Implement - TA_EditSoldCoupon

api.TA_EditSoldCoupon = class {
    ...
    static async call(db, params) { 
        return db.TA_EditSoldCoupon(params)
    }
...
router.all('/', api.TA_EditSoldCoupon.entry)

const init_routes = (svr) => {
    svr.route('/api/TA/coupons/editserialno', router);
};
